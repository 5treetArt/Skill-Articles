...
data class ArticleItemData(
    ...
    val title: String = "Drawing a rounded corner background on text Drawing a rounded corner background on text Drawing a rounded corner background on text Drawing a rounded corner background on text Drawing a rounded corner background on text Drawing a rounded corner background on text Drawing a rounded corner background on text Drawing a rounded corner background on text",
