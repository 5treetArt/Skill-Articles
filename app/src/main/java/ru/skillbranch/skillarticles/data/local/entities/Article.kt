...
@DatabaseView("""
    ...
    count.likes AS like_count, counts.comments AS comment_count, counts.read_duration AS read_duration,
...
@DatabaseView("""
    ...
    LEFT JOIN article_personal_infos AS personal.article_id = id
""")
